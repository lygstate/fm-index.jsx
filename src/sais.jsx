...
__export__ class SAIS
{
    ...
    // compute SAl
    static function _induceSAl(t : ArrayBitVector, SA : int[], s : OArray, bkt : int[], n : int, K : int, end : boolean) : void
    {
    ...
    // compute SAs
    static function _induceSAs(t : ArrayBitVector, SA : int[], s : OArray, bkt : int[], n : int, K : int, end : boolean) : void
    {
